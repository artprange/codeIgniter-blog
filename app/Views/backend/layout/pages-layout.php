...
<html>
	<head>
		...
		<link
			...
			sizes="180x180"
			href="/backend/vendor/images/apple-touch-icon.png"
		/>
		<link
			rel="icon"
			type="image/png"
			...
			href="/backend/vendor/images/favicon-32x32.png"
		/>
		<link
			rel="icon"
			type="image/png"
			sizes="16x16"
			href="/backend/vendor/images/favicon-16x16.png"
		/>
		...
		<link
			rel="stylesheet"
			type="text/css"
			href="/backend/vendor/styles/icon-font.min.css"
		/>
			...
			<div class="header-right">
				...
				<div class="github-link">
					<a href="https://github.com/dropways/deskapp" target="_blank"
						><img src="/backend/vendor/images/github.svg" alt=""
					/></a>
				</div>
			</div>
		</div>
		...
		<div class="left-side-bar">
			<div class="brand-logo">
				<a href="index.html">
					...
					<img
						src="/backend/vendor/images/deskapp-logo-white.svg"
						alt=""
						class="light-logo"
					/>
				</a>
					...
					<ul id="accordion-menu">
						...
						<li>
							...
							>
								...
								<span class="mtext"
									>Landing Page
									<img src="/backend/vendor/images/coming-soon.png" alt="" width="25"
								/></span>
							</a>
						</li>
					</ul>
